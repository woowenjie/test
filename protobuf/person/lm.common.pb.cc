...
const ::google::protobuf::EnumDescriptor* PhoneNumber_PhoneType_descriptor_ = NULL;

}  // namespace


void protobuf_AssignDesc_lm_2ecommon_2eproto() {
  protobuf_AddDesc_lm_2ecommon_2eproto();
  ...
  PhoneNumber_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      sizeof(PhoneNumber));
  PhoneNumber_PhoneType_descriptor_ = PhoneNumber_descriptor_->enum_type(0);
}
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_lm_2ecommon_2eproto);
}
...
void protobuf_AddDesc_lm_2ecommon_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\017lm.common.proto\022\002lm\"y\n\013PhoneNumber\022\016\n\006"
    "number\030\001 \002(\t\022-\n\004type\030\002 \001(\0162\031.lm.PhoneNum"
    "ber.PhoneType:\004HOME\"+\n\tPhoneType\022\n\n\006MOBI"
    "LE\020\001\022\010\n\004HOME\020\002\022\010\n\004WORK\020\003", 144);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "lm.common.proto", &protobuf_RegisterTypes);
  PhoneNumber::default_instance_ = new PhoneNumber();
  PhoneNumber::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_lm_2ecommon_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_lm_2ecommon_2eproto {
  StaticDescriptorInitializer_lm_2ecommon_2eproto() {
    protobuf_AddDesc_lm_2ecommon_2eproto();
  }
} static_descriptor_initializer_lm_2ecommon_2eproto_;
...
const ::google::protobuf::EnumDescriptor* PhoneNumber_PhoneType_descriptor() {
  protobuf_AssignDescriptorsOnce();
  return PhoneNumber_PhoneType_descriptor_;
}
...
const PhoneNumber& PhoneNumber::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_lm_2ecommon_2eproto();  return *default_instance_;
}
        ...
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_type:
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                 ...
                 input, &value)));
          if (::lm::PhoneNumber_PhoneType_IsValid(value)) {
            set_type(static_cast< ::lm::PhoneNumber_PhoneType >(value));
          } else {
